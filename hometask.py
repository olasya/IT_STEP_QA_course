...
print("Посчитать количество элементов в строке text_a")
print (len(text_a))
#  4. Посчитать количество элементов в строке text_b
print("Посчитать количество элементов в строке text_b")
print (len(text_b))
#  5. Посчитать сумму элементов списка ages
print("Посчитать сумму элементов списка ages")
sum(ages)
#  6. Вывести максимальный элемент списка ages
print("Вывести максимальный элемент списка ages")
max(ages)
